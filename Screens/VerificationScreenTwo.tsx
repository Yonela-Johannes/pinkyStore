...
export default function VerificationScreenTwo({navigation}) {
    ...
    const [code, setCode] = useState('')
        ...
        const register = async () => {
            try{
                ...
                Alert.alert("OOPS!", 'Wrong usename and verification code validation', [{ text: "Understood"}])
            }
        }
        ...
        const resendCode = async () => {
            try{
                ...
                Alert.alert("Congratulations!", "code resent successfully", [{text: "Understood"}])
            }catch(error) {
            ...
            <ScrollView style={styles.root}>
                <View style={styles.inputContainer}>
                    ...
                    <View>
                        ...
                        <TextInput style={styles.input} placeholder={"Authentication code"} autoCapitalize='none' value={code} onChangeText={setCode} />
                    </View>
                </View>
